...
def movebase_client(x1,y1,o1,o2,o3,o4):
   ...
   # No rotation of the mobile base frame w.r.t. map frame
    goal.target_pose.pose.orientation.x = o1
    goal.target_pose.pose.orientation.y = o2
    goal.target_pose.pose.orientation.z = o3
    goal.target_pose.pose.orientation.w = o4
...
class Pencere (QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.hes =QtWidgets.QPushButton("Noktaya git")
    ...
    def click(self):
        ...
        if sender.text() == "Temizle":
            ...
            try:
                ...
                result = movebase_client(e1,e2,f5,f6,f7,f8)
                if result:
